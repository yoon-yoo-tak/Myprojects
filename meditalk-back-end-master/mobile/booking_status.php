...
<body>
    ...
    <div style="background:white; margin-top:7%;">
    <!--병원이름-->
    <div>
        <div id="hp-name-box">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-right" style="color:rgb(52,68,110);"><?=$row['bf_date']." ".$row['bf_time']?></td>
        </tr>
        <!--담당의사-->
        <tr>
            <td class="text-left">담당의사</td>
            <td class="text-right" style="color:rgb(52,68,110);"><?=$ms_obj['ms_name']?></td>
        </tr>
        <!--예약취소 버튼-->    
        <tr>
            <td></td>
            <td class="text-right" style="color:rgb(52,68,110);">
                <b class='cancle-btn' bf_number="<?=$row['number']?>">예약취소</b>
            </td>
        </tr>    
    </table>    
    </div>
    <hr style="border-color:rgb(230,230,230); border-width:2px;">
    <?php
